...
/** IntegracionJpaTest:
 * 
 * Esta clase esta destinada a las pruebas de integración 
 * entre nuestra clase repositorio y una base de datos
 */

@DataJpaTest // Anotación para cargar todo el contexto de pruebas de persistencia
public class IntegracionJpaTest {
    ...
    void testFindById() {
        ...
        assertEquals("Fede", cuenta.orElseThrow().getPersona());
    }

    @Test
    void testFindByPersona() {
        Optional<Cuenta> cuenta = cuentaRepository.findByPersona("Fede");
        assertTrue(cuenta.isPresent());
        assertEquals("Fede", cuenta.orElseThrow().getPersona());
    ...
    void testFindByPersonaThrowException() {
        Optional<Cuenta> cuenta = cuentaRepository.findByPersona("Rodrigo");
...
//        assertEquals(3, cuenta.getId());
    ...
    void testDelete() {
        ...
        assertEquals("Patri", cuenta.getPersona());

        cuentaRepository.delete(cuenta);

        assertThrows(NoSuchElementException.class, () -> {
//            cuentaRepository.findByPersona("Patri").orElseThrow();
